# -*- coding: utf-8 -*-
"""
Created on Fri Jun 18 21:45:06 2021
...
""" Rotation of Qubits with disorder introduced at each hierarchical lattice points"""
...
def main():
    ...
    for j in range(2):
      ...
      plt.xlim(0, 0.2)
      plt.savefig(f"plots/hierarchical_disorder_plots/{round(j,2)} plot.png", dpi=600)
